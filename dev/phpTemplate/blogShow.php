...
try {
    ...
    $blogsArticle = $pdo->prepare($sql_b);
	$blogsArticle->bindValue(":blogname", $_GET["blogname"]);
    $blogsArticle->execute();
    $blogsArticleInfo = $blogsArticle->fetch(PDO::FETCH_ASSOC);
...
<div class="containerBlog">
    <div class="coverPhoto">
        <img src="<?=$blogsArticleInfo["Blog_PicURL"];?>" >
    </div>
