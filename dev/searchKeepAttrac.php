...
try{
    ...
    $sql = "select * from keep_attrac k left join attraction a on k.Attrac_NO=a.Attrac_NO where Mem_NO=:MemNO and Picture1 like 'http%' and Picture1 not like 'http://210%'";
