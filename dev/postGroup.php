    ...
    if ($reupload==false||move_uploaded_file($_FILES["file-upload"]["tmp_name"], $target_file)) {
        try{
            ...
            $sql = "UPDATE GroupTable SET Group_title=:Group_title,Group_StartDate=:Group_StartDate,Group_EndDate=:Group_EndDate,".
                "Group_Deadline=:Group_Deadline,Group_Ppl=:Group_Ppl,Group_Sex=:Group_Sex,Group_Age=:Group_Age,Group_Fee=:Group_Fee,Group_Place=:Group_Place,Group_Pic=:Group_Pic,Group_Com=:Group_Com,Group_Status=1  ".
